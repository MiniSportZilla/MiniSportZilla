...
contract MiniSportZilla is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address _router ,address _owner,address _marketingWallet, address _developmentWallet, address _pinkAntiBot, address _miniFloki) public {
